...
ValidationTest.prototype.validate = async function(jobInfo, currentContextData, onComplete) {
    var self = this;
...
ValidationTest.prototype.saveReportLocally = function() {
    ...
    if (!this.vlocity.utilityservice.isEmptyObject(testReport)) {
        fs.outputFileSync(path.join('vlocity-temp', 'validationTest', this.jobInfo.logName), yaml.dump(testReport), 'utf8');
    }
