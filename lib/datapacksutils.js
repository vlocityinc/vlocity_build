...
DataPacksUtils.prototype.traverseEachDatapack = function(dataPack, sourceKeyToDataMap) {
        ...
        if (dataPack[dataPackField]) {
            if (dataPack[dataPackField] instanceof Array) {
                for (var i = 0; i < dataPack[dataPackField].length; i++) {
                    ...
                    sourceKeyToDataMap = this.traverseEachDatapack(dataPack[dataPackField][i], sourceKeyToDataMap);
                }
                ...
                && dataPack[dataPackField][0].VlocityRecordSObjectType) {
                    sourceKeyToDataMap = this.traverseEachDatapack(dataPack[dataPackField][0], sourceKeyToDataMap);
            }
        }
    }
    if(dataPack.VlocityRecordSourceKey && ! sourceKeyToDataMap[dataPack.VlocityRecordSourceKey]){
