...
DataPacksUtils.prototype.getListFileName = function(dataPackType, SObjectType, isTargetStmpa) {
  
    var listFileNameKeys = this.getExpandedDefinition(dataPackType, SObjectType, "ListFileName", isTargetStmpa);
...
DataPacksUtils.prototype.getFileName = function(dataPackType, SObjectType, isTargetStmpa) {
    return this.getExpandedDefinition(dataPackType, SObjectType, "FileName", isTargetStmpa);
}
...
DataPacksUtils.prototype.getFolderName = function(dataPackType, SObjectType, isTargetStmpa) {
    return this.getExpandedDefinition(dataPackType, SObjectType, "FolderName", isTargetStmpa);
}

DataPacksUtils.prototype.getFileType = function(dataPackType, SObjectType, isTargetStmpa) {
    return this.getExpandedDefinition(dataPackType, SObjectType, "FileType", isTargetStmpa);
}
...
DataPacksUtils.prototype.getExpandedDefinition = function(dataPackType, SObjectType, dataKey, isTargetStmpa) {
    let definitionValue;
    if (isTargetStmpa && !this.vlocity.namespace) {
...
DataPacksUtils.prototype.updateDataPackWithNewMappings = function (dataPack, jobInfo) {
    ...
    let mappings = jobInfo.platformObjectMappings[dataPackType][dataField];
    ...
    if (mappings) {
        ...
        Object.keys(obj[newDataField][0]).forEach(key => {
            ...
            if (Object.keys(jobInfo.platformObjectMappings[dataPackType]).includes(key)) {
                let subMappings = jobInfo.platformObjectMappings[dataPackType][key];
                    ...
                    Object.keys(subObj).forEach(fieldName => {
                        if (subMappings.fieldNames[fieldName]) {
                            ...
                            if (subObj[fieldName].VlocityMatchingRecordSourceKey) {
                                ...
                                subObj[fieldName].VlocityRecordSObjectType = newDataField;
