...
DataPacksUtils.prototype.getDeltaMetadataCheck = function(SObjectType) {
    return this.getExpandedDefinition(null, SObjectType, 'DeltaMetadataCheck');
};
    ...
    for (var i = 0; i < allFields.length; i++) {
        ...
        && sourceObject[field] != targetObject[field]) {
            ...
            if (sourceObjParsed != null 
                ...
                && !Array.isArray(sourceObjParsed) 
                && !Array.isArray(targetObjParsed)) {
            ...
            if ((sourceObject[field] != null && typeof sourceObject[field] == 'object') 
                ...
                if (!(sourceObjectValue === "" && targetObjectValue === "")) {
                    ...
                    fieldDiffs.push({
                        ...
                        gitDiff: this.getGitDiffs(targetObjectValue, sourceObjectValue),
                        status: fieldStatus,
...
DataPacksUtils.prototype.setNestedFieldDiffs = async function(sourceObject, targetObject, currentPath, fieldDiffs,  vlocityRecordSourceKey, sObjectType) {
    ...
    for (var field in sourceObject) {
        ...
        var fieldType = this.getFieldDisplayType(dataPackType, sObjectType, fieldPath);
