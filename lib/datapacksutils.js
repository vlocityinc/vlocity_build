...
DataPacksUtils.prototype.getFieldDiffsIndividual = async function(allSourceDataPacks, allTargetDataPacks, jobInfo, dataPackKey) {
    try {
        ...
        if (sourceDataPack.VlocityDataPackData && sourceDataPack.VlocityDataPackData[this.vlocity.datapacksutils.getDataField(sourceDataPack)]) {
            jobInfo.VlocityDataPackKeyToUrlMapping[dataPackKey] = sourceDataPack.VlocityDataPackData[this.vlocity.datapacksutils.getDataField(sourceDataPack)][0].orgUrl;
        }
...
var ignoredFields = new Set([ 'VlocityRecordSourceKey',  'VlocityRecordSourceKeyOriginal', 'CurrencyIsoCode', 'VlocityRecordSObjectType', 'VlocityDataPackIsIncluded', 'VlocityDataPackType', 'VlocityDiffParentField', 'VlocityDiffParentKey', 'orgUrl' ]);
...
var standardValueSetsMetadata = [
    ...
    "StandardValueSet:WorkOrderLineItemStatus",
    "StandardValueSet:WorkOrderPriority",
    "StandardValueSet:WorkOrderStatus"
];
        ...
        for (let file of this.getFiles(path.join(sfdxProject.sfdxPath, sfdxFolder, dir))) {
            ...
            if (file[0] != '.') {
                ...
                try {
                    ...
                    if (manifestKeysForSFDX && manifestKeysForSFDX.indexOf(dataPackKey) == -1) {
                        continue;
                    }
