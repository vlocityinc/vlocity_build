...
DataPacksUtils.prototype.loadApex = function(projectPath, filePath, currentContextData) {
    ...
    if (this.vlocity.datapacksutils.fileExists(projectPath + '/' + filePath)) {
        ...
        var apexFileName = path.join(projectPath, filePath);
    ...
    return this
        ...
        .then((apexFileData) => { 
            return new Promise((resolve, reject) => {
                ...
                if (apexFileData.length > 30000) {
                    return reject('Apex Code too long. Use preStepApex or lower MaxDeploy for the DataPack type in the OverrideSettings');
                }
