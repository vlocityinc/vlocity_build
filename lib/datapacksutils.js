...
DataPacksUtils.prototype.getVisualForcePage = function(dataPackType) {
    ...
    try {
        ...
        if (sourceDataPack.hasOwnProperty('SFDXData')) {
            ...
            if (dataPackStatus == 'Changed') {
                ...
                if (targetDataPack) {
                    if(targetDataPack.VlocityDataPackData[dataField]){
                        allTargetSObjects = this.getAllIndividualSObjectsInDataPack(targetDataPack.VlocityDataPackData[dataField][0]);
                    } else {
                        allTargetSObjects = this.getAllIndividualSObjectsInDataPack(targetDataPack.VlocityDataPackData[dataField.replace('%vlocity_namespace%__','')][0]);
                    }
                }
...
DataPacksUtils.prototype.getTitleFieldsForDataPack = async function(sourceDataPack, targetDataPack, diffObject) {
    ...
    if (targetDataPack) {
        if(targetDataPack.VlocityDataPackData[dataField]){
            ...
            targetPrimarySObject = targetDataPack.VlocityDataPackData[dataField.replace('%vlocity_namespace%__','')][0];
        }
    }
