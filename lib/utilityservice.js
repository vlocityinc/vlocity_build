...
UtilityService.prototype.setVlocitySetting = async function(settingName, value) {
    try {    
        ...
        if (settingsRecord.Id) {
            if (this.vlocity.isOmniStudioInstalled) {
                VlocityUtils.verbose('Set Setting Update', await this.vlocity.jsForceConnection.sobject('OmniInteractionConfi').update([ settingsRecord ], {}));
            } else {
            ...
            if (this.vlocity.isOmniStudioInstalled) {
                VlocityUtils.verbose('Set Setting Insert', await this.vlocity.jsForceConnection.sobject('OmniInteractionConfi').insert([ settingsRecord ], {}));
            } else {
