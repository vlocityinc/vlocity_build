...
UtilityService.prototype.sfdx = async function(command, options) {   
    ...
    var saveWrite = process.stderr.write;

    process.stderr.write = this.handlestderr;
    var result;
    ...
    process.stderr.write = saveWrite;
    if (result) {
        return result;
    } else {
...
UtilityService.prototype.handlestderr = function(...args) {
    try {
