...
// Changed the below logic to only find the git diff for projectpath/expansionPath components as VBT was removing the components earlier in case they were merged mistakenly outside the projectPath and later moved to project/expansion Path.
