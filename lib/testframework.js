...
TestFramework.prototype.start = async function(input) {
    ...
    let result =  await this.vlocity.jsForceConnection.apex.post('/' + this.vlocity.namespace + '/v1/testframework/start', request);
    return this.toJson(result);
};

TestFramework.prototype.startAll = async function() {
    let result = await this.vlocity.jsForceConnection.apex.post('/' + this.vlocity.namespace + '/v1/testframework/startAll');
    return this.toJson(result);
};
