...
VlocityCLI.prototype.runCommands = async function(commands, options) {
    ...
    for (var command of commands) {
        ...
        //  Must test failures and have pattern!!
    ...
    return self.formatResponseCLI(finalResult);
        ...
        /*
            ...
            if (err) {
                return self.formatResponseCLI(err);
            } else {
                returnself.formatResponseCLI(finalResult);
            }
        });*/
}
    ...
    if (dataPacksJobData) {
        ...
        if (typeof dataPacksJobData.manifest === 'string') {
            try {
                ...
                return self.formatResponseCLI({ message: 'Invalid Manifest JSON:'+ dataPacksJobData.manifest + '\n' +  e.message, status: 'error' });
            }
