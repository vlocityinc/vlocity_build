    ...
    for (var command of commands) {
        ...
        if (command === 'DeployManifest') {
            ...
            testJobData.buildFile = {
                0: path.join(__dirname, '..', 'test', 'rawDataPacks', 'datapacktest_dr_extract.json'),
                1: path.join(__dirname, '..', 'test', 'rawDataPacks', 'datapacktest_dr_turbo.json'),
            ...
            testJobData.manifest = [
                ...
                "DataRaptor/datapacktest_Extract",
                "DataRaptor/datapacktest_Turbo"
            ];
            ...
            testJobData.javascript = "../test/javascript/testImport.js";
        }
        ...
        if (command === 'runTestProcedure' && result.data.testResults[0].trackingEntry.length != 10) {
            result.status = 'error';
        }
