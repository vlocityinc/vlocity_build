...
DeltaCheck.prototype.deltaCheck = function(jobName, jobInfo, currentContextData) {
    ...
    this.vlocityMatchingKeys = this.vlocity.utilityservice.getDRMatchingKeyFields();
    
    this.getAllRecordsToQueryFor(currentContextData);
