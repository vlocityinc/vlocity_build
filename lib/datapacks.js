            ...
            if (err) { 
                ...
                return new Promise(function(resolve) {
                    ...
                    if (result.Total > 0 
                        ...
                        async.eachSeries([ result.VlocityDataPackId ], function(vId, callback) {
                            self.getDataPackData(vId, function(dataPackFound) {
                                dataPackFound.dataPacks.forEach(function(dataPack) {
                                    if (dataPack.VlocityDataPackRelationshipType == "Children" && dataPack.VlocityDataPackStatus == "Ready") {
