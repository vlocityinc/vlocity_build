...
Vlocity.compare = async function(options) {
    ...
    if (options.source == 'local') {
        if (!options.projectSetKeys) {
            ...
            if (typeof options.projectSetKeys === 'string') {
                options.projectSetKeys = JSON.parse(options.projectSetKeys);
            }
    
            var allParentsByKey = {};
            options.manifest = options.projectSetKeys;
            for (var dataPack of options.sourceData.dataPacks) {
