...
Vlocity.prototype.getPackageVersion = function(onSuccess, onError) {
    ...
    if (self.packageVersion) {
        ...
        self.jsForceConnection.query("SELECT DurableId, Id, IsSalesforce, MajorVersion, MinorVersion, Name, NamespacePrefix FROM Publisher where NamespacePrefix = \'" + self.namespace + "\' LIMIT 1", function(err, result) {
