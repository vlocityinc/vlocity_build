    ...
    if (options.source == 'local' && options.projectKeys) {
        ...
        for (var dataPack of options.sourceData.dataPacks) {   
            if (options.projectKeys.includes(dataPack.VlocityDataPackKey) 
                || options.projectKeys.includes(datapacksutils.withoutMetadataExtension(dataPack.VlocityDataPackKey))
                || options.projectKeys.includes(dataPack.VlocityDataPackKey + '-meta.xml')) {
