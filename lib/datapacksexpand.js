...
// Gated by enforceSecurityValidations (default on); a customer may opt out via job YAML / CLI
// if a legitimate workflow must write outside the project directory.
DataPacksExpand.prototype.assertPathWithin = function(baseDir, targetPath) {
    ...
    if (this.enforceSecurityValidations !== false &&
