...
DataPacksExpand.prototype.getNameWithFields = function(nameFields, dataPackData) {
    ...
    var processedNames = (nameFields || []).map(function(key) {
        ...
        if (key.indexOf('_') == 0) {
            ...
            return self.getDataPackFolder(null, dataPackData[key].VlocityRecordSObjectType, dataPackData[key], jobInfo.upgradeDataPackFields);
        }
    });    
...
DataPacksExpand.prototype.getDataPackName = function(dataPackType, sObjectType, dataPackData, isTargetStmpa) {
    var name = this.getNameWithFields(this.vlocity.datapacksutils.getFileName(dataPackType, sObjectType, isTargetStmpa), dataPackData);
    return name ? name : dataPackType;
};

DataPacksExpand.prototype.getListFileName = function(dataPackType, sObjectType, dataPackData, isTargetStmpa) {
    var name = this.getNameWithFields(this.vlocity.datapacksutils.getListFileName(dataPackType, sObjectType, isTargetStmpa), dataPackData);
    return name ? name : dataPackType;
};

DataPacksExpand.prototype.getDataPackFolder = function(dataPackType, sObjectType, dataPackData, isTargetStmpa) {
    return this.getNameWithFields(this.vlocity.datapacksutils.getFolderName(dataPackType, sObjectType, isTargetStmpa), dataPackData);
}; 
