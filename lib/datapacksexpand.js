...
DataPacksExpand.prototype.processDataPackData = async function(dataPackType, parentName, filename, dataPackData, isPagination, jobInfo) {
    var self = this;
                    ...
                    if (expansionData) {
                        if (expansionType == "list") {
                            ...
                            for (var childInList of expansionData) {
                                listExpansion.push(await self.processDataPackData(dataPackType, parentName, packName, childInList, isPagination, jobInfo));
                            }
