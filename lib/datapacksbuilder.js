...
var DataPacksBuilder = module.exports = function(vlocity) {
    ...
    this.builtDataPacks = {};
    this.dataPackSizes = {};
    this.dataPackDataMetadataSaved = {};
};
...
DataPacksBuilder.prototype.buildImport = function(importPath, jobInfo, typesInAllImports, onComplete) {
    ...
    if (jobInfo.resetFileData) {
        self.builtDataPacks = {};
        self.dataPackDataMetadataSaved = {};
    ...
    for (var i = 0; i < dataPackKeys.length; i++) {
        ...
        if (jobInfo.currentStatus[dataPackKey] == 'Ready' 
            ...
            try {
                ...
                if (!self.dataPackDataMetadataSaved[dataPackKey]) {
                    self.dataPackDataMetadataSaved[dataPackKey] = JSON.parse(self.getFileData(fullPathToFiles, dataPackLabel + '_DataPack.json'));
                }

                var dataPackDataMetadata = self.dataPackDataMetadataSaved[dataPackKey];
