                    ...
                    potentialFileNames.forEach(function(fileInArray) {
                        ...
                        if (fileData) {
                            try {
                                ...
                                jobInfo.currentStatus[dataPackKey] = 'Error';
                                jobInfo.errors.push(`Error Building DataPack ${dataPackKey} Corrupt File ${fullPathToFiles} ${e}`)
                                VlocityUtils.error('Error Building DataPack', dataPackKey, 'Corrupt File', fullPathToFiles, e);
                            }
                        } else {
