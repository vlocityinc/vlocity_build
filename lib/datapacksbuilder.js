        ...
        Object.keys(childData).forEach((sobjField) => {
            if (sobjField != "VlocityDataPackType"
                ...
                && matchingObjectKeys.indexOf(sobjField) === -1) {
                    let matchingSourceKey = childData.VlocityMatchingRecordSourceKey || childData.VlocityLookupRecordSourceKey;
                    if(jobInfo.sourceKeyToMatchingKeysData[matchingSourceKey] 
                        && jobInfo.sourceKeyToMatchingKeysData[matchingSourceKey][key]){
                            childData[key] = jobInfo.sourceKeyToMatchingKeysData[matchingSourceKey][key];
