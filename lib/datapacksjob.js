...
DataPacksJob.prototype.exportGroup = async function(inputMap) {
    ...
    if (exportData.length != 0) {
        ...
        var processedKeys = {};
        if(!jobInfo.VlocityDataPackKeyToUrlMapping){
            jobInfo.VlocityDataPackKeyToUrlMapping = {};
        }
        ...
        for (var dataPack of dataPackData.dataPacks) {
            ...
            if (dataPack.VlocityDataPackStatus == 'Success') {
                ...
                if (!jobInfo.maxDepth || jobInfo.maxDepth == -1 || dataPack.VlocityDepthFromPrimary == 0) {
                    ...
                    jobInfo.VlocityDataPackKeyToUrlMapping[dataPack.VlocityDataPackKey] = this.vlocity.utilityservice.getVisualForcePageUrl(dataPack.VlocityDataPackType, dataPack.VlocityDataPackData[dataField][0].Id);
