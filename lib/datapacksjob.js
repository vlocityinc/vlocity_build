...
DataPacksJob.prototype.downloadPerformanceData = async function (jobInfo) {
    return new Promise(async (resolve, reject) => {
        ...
        var query = `SELECT ${field_name},CreatedBy.Username,CreatedBy.Name FROM ${this.vlocity.namespace}__VlocityTrackingEntry__c WHERE Name = 'StepActionTime' ORDER BY CreatedDate DESC`;
        var records = [];
            ...
            .on("end", async function () {
                ...
                records.map(item => {
                    try {
                        ...
                        element_data.UserProfile = item.CreatedBy.Name;
