    ...
    if(jobInfo.deployGeneratedLwc === true) {
        if(!fs.existsSync(tempSfdxLwcFolder)) {
            ...
            try {
                ...
                VlocityUtils.log('sfdx force:source:convert ended successfully');
                ...
                VlocityUtils.log('sfdx force:mdapi:deploy ended successfully');
                mdapiDeployResult?.result?.details?.componentSuccesses
                    ?.forEach((metadata) => {
