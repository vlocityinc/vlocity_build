...
DataPacksJob.prototype.exportJob = async function(jobInfo) {
    ...
    if (jobInfo.autoUpdateSettings && !this.vlocity.isOmniStudioInstalled) {
                ...
                while (unique_omni_id.length > 0) {
                    try{
                        ...
                        if (unique_omni_id_format) {
                            ...
                            let additional_data = await self.vlocity.jsForceConnection.query(this.vlocity.omnistudio.updateQuery(`SELECT ${self.vlocity.namespace}__PropertySet__c,Name,${self.vlocity.namespace}__Type__c,${self.vlocity.namespace}__OmniScriptId__c 
