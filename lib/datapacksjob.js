...
DataPacksJob.prototype.refreshVlocityBase = async function(jobInfo) {
    let result = await this.vlocity.jsForceConnection.query("Select Name, Body from StaticResource where Name LIKE 'DP_CARDS%' OR Name LIKE 'DP_TEMPLATES%' OR Name LIKE 'DP_CPQ%'");
