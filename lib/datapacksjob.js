        ...
        this.vlocity.jsForceConnection.query(query)
            ...
            .on("end", async function () {
                ...
                additional_data.records.map(item => {
                    ...
                    records.map(item => {
                        var element_name= JSON.parse(item[field_name]).ElementName;
                        var element_omniScript_id= JSON.parse(item[field_name]).OmniScriptId;
                        var element_type= JSON.parse(item[field_name]).ElementType;
                        var element_data=JSON.parse(item[field_name])
