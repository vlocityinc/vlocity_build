...
DataPacksJob.prototype.runDeltaCheck = async function(jobInfo, checkStaleObjects) {
    ...
    jobInfo.disablePagination = true;
    jobInfo.fullStatus = true;
    jobInfo.checkStaleObjects = checkStaleObjects;
