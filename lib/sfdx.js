...
// escaping any embedded single quotes (CWE-78, W-24098246). Unlike the double-quoted
// "${param}" style used elsewhere in this file, single-quoting disables ALL shell
// metacharacter interpretation (;, $(), backticks, |, &&, etc.), not just word-splitting.
