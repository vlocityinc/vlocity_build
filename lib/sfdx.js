...
// enableShellArgEscaping to true to turn on single-quote escaping.
let enableShellArgEscaping = false;
const setEnableShellArgEscaping = (value) => {
    enableShellArgEscaping = value === true;
}
